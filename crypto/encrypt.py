# From https://github.com/Kevin0z0/Python_NetEaseMusicAPI/blob/master/api/utils/encrypt.py
...
__all__ = ["we_encrypt", "linux_encrypt", "e_encrypt", "MD5"]
